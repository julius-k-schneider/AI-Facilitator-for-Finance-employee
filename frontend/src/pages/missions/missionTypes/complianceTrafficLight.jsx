...
export default {
  ...
  evaluateTest: (mission, answer) => { const correctCount = answer.filter((value, index) => value === mission.test_solution.correct_colors[index]).length; return { correct: correctCount === answer.length, score: Math.floor(mission.max_points * correctCount / answer.length), max_points: mission.max_points, correct_count: correctCount, total_count: answer.length, correct_colors: mission.test_solution.correct_colors, feedback: mission.test_solution.feedback } },
